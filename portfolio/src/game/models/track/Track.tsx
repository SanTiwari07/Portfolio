...
interface TrackGLTF extends GLTF {
  nodes: {
    track_2: Mesh; tube: Mesh; strip: Mesh; track_1: Mesh; mountains: Mesh; terrain: Mesh; water: Mesh
    bird001: Mesh; bird002: Mesh; bird003: Mesh; bird: Mesh
    blade001: Mesh; blade002: Mesh; blade003: Mesh; blade004: Mesh; blade005: Mesh; blade006: Mesh; blade: Mesh
    cloud001: Mesh; cloud002: Mesh; cloud003: Mesh; cloud004: Mesh; cloud005: Mesh; cloud006: Mesh
    cloud007: Mesh; cloud008: Mesh; cloud009: Mesh; cloud010: Mesh; cloud011: Mesh; cloud012: Mesh; cloud: Mesh
  }
  materials: {
...
function RoadCollider({ geometry }: { geometry: import('three').BufferGeometry }) {
  const vertices = geometry.attributes.position.array as unknown as Float32Array
  let indices = geometry.index?.array as unknown as Uint16Array | Uint32Array
  
  // If the GLTF geometry is unindexed, we MUST generate sequential indices for useTrimesh
  // otherwise it will have 0 triangles and the road will have no collision!
  if (!indices) {
...
export function Track(): JSX.Element {
  ...
  return (
    <group dispose={null}>
      ...
      <group ref={level}>
        <RoadCollider geometry={n.track_1.geometry} />
