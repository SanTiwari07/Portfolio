    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 md:px-12 text-center py-24">
        ...
        >
          ...
          <span className="text-[10px] tracking-[0.5em] uppercase text-text-secondary font-medium transition-colors duration-700">08 / Contact</span>
          <div className="w-8 h-[1px] bg-primary transition-colors duration-700" />
        </motion.div>
          ...
          {contactLinks.map((link, i) => (
            <MagneticButton key={link.label} strength={20}>
              <motion.a
                ...
                className="group flex flex-col items-center gap-3 p-6 border border-border-light hover:border-primary hover:bg-primary/10 transition-all duration-400 w-full h-full"
                initial={{ opacity: 0, y: 20 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
